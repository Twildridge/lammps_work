...
run_nb triaxial_compression_single_two_pist.ipynb "s = s.replace('RUN_ID      = \"two_pist_comp_1\",', 'RUN_ID      = \"fixture_comp\", base_dir=\"' + root + '/flow_data_local\",').replace('DATANAME    = \"final_config_slab_support_periodic_5beads_tall_rho04_new_1.0_1.0_14000002_two_pist\"', 'DATANAME    = \"fixture_slab\"').replace('VOR_ENABLE = True,', 'VOR_ENABLE = False,')"
run_nb triaxial_compression_sweep_two_pist.ipynb "s = s.replace('RUN_ID      = \"two_pist_comp_1\",', 'RUN_ID      = \"fixture_comp\", base_dir=\"' + root + '/flow_data_local\",').replace('DATANAME    = \"final_config_slab_support_periodic_5beads_tall_rho04_new_1.0_1.0_14000002_two_pist\"', 'DATANAME    = \"fixture_slab\"').replace('COMP_LEVELS = [\"0.05\", \"0.10\", \"0.15\", \"0.20\"]', 'COMP_LEVELS = [\"0.05\", \"0.10\"]').replace('VOR_ENABLE = True,', 'VOR_ENABLE = False,')"
run_nb triaxial_permeation_single_two_pist.ipynb "s = s.replace('RUN_ID      = \"two_pist_perm_1\",', 'RUN_ID      = \"fixture_perm\", base_dir=\"' + root + '/flow_data_local\",').replace('DATANAME    = \"final_config_slab_support_periodic_5beads_tall_rho04_new_1.0_1.0_14000002_two_pist\"', 'DATANAME    = \"fixture_slab\"')"
